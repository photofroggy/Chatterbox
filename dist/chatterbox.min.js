...
Chatterbox.template.settings.item.form.field.colour={};Chatterbox.template.settings.item.form.field.colour.post=Chatterbox.template.clean(["ref","default"]);Chatterbox.template.settings.item.form.field.colour.frame='<input class="{ref}" type="color" value="{default}" />';Chatterbox.Extension=function(c,a){var e=a.storage.folder("ui");var b={page:{},cmd:{}};c.storage=e;var d=function(){c.on("settings.open",b.page.settings);c.on("settings.open.ran",b.page.about);c.on("settings.save.ui",b.save);c.on("settings.save",function(){a.config_save()});a.bind("cmd.gettitle",b.cmd.gett);a.bind("cmd.gettopic",b.cmd.gett);a.bind("cmd.clear",b.cmd.clear);a.bind("cmd.clearall",b.cmd.clearall);a.bind("cmd.theme",b.cmd.theme);Chatterbox.Extension.Away(c,a,b);Chatterbox.Extension.Autojoin(c,a,b);b.load();b.save()};b.save=function(){e.set("theme",c.settings.theme);e.set("clock",c.settings.clock.toString());e.set("tabclose",c.settings.tabclose.toString())};b.load=function(){c.settings.theme=e.get("theme",c.settings.theme);
