...
Chatterbox.template.settings.item.form.field.colour={};Chatterbox.template.settings.item.form.field.colour.post=Chatterbox.template.clean(["ref","default"]);Chatterbox.template.settings.item.form.field.colour.frame='<input class="{ref}" type="color" value="{default}" />';Chatterbox.Extension=function(c,a){var e=a.storage.folder("ui");var b={page:{},cmd:{}};c.storage=e;var d=function(){c.on("settings.open",b.page.settings);c.on("settings.open.ran",b.page.about);c.on("settings.save.ui",b.save);c.on("settings.save",function(){a.config_save()});a.bind("cmd.gettitle",b.cmd.gett);a.bind("cmd.gettopic",b.cmd.gett);a.bind("cmd.clear",b.cmd.clear);a.bind("cmd.clearall",b.cmd.clearall);a.bind("cmd.theme",b.cmd.theme);Chatterbox.Extension.Away(c,a,b);b.load();b.save()};b.save=function(){e.set("theme",c.settings.theme);e.set("clock",c.settings.clock.toString());e.set("tabclose",c.settings.tabclose.toString())};b.load=function(){c.settings.theme=e.get("theme",c.settings.theme);c.settings.clock=(e.get("clock",c.settings.clock.toString())=="true");
c.settings.tabclose=(e.get("tabclose",c.settings.tabclose.toString())=="true")};b.page.settings=function(j,h){console.log(">> main settings");var g=j.settings.page("Main");var k={};k.username=a.settings.username;k.pk=a.settings.pk;k.devel=a.settings.developer;k.theme=replaceAll(h.settings.theme,"wsct_","");k.clock=h.clock();k.tc=h.nav.closer();var f=[];for(i in h.settings.themes){name=replaceAll(h.settings.themes[i],"wsct_","");f.push({value:name,title:name,selected:k.theme==name})}g.item("Text",{ref:"intro",title:"Main",text:"Use this window to view and change your settings.\n\nCheck                    the different pages to see what settings can be changed.",});g.item("Form",{ref:"login",title:"Login",text:"Here you can change the username and token used to                    log into the chat server.",fields:[["Textfield",{ref:"username",label:"Username","default":k.username}],["Textfield",{ref:"token",label:"Token","default":k.pk}]],event:{save:function(l){a.settings.username=l.data.username;
